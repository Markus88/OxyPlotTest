...
void xamarin_register_assemblies ()
{
	...
	xamarin_open_and_register ("OxyPlot.Xamarin.Forms.Platform.iOS.dll");
	xamarin_open_and_register ("Xamarin.Forms.Platform.iOS.dll");
	xamarin_open_and_register ("OxyPlot.Xamarin.iOS.dll");
...
void xamarin_setup ()
{
	...
	xamarin_executable_name = "OxyPlotTest01.iOS.exe";
